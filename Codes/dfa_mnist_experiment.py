...
print('BP Method test error:', test(W1, W2 ,W3, b1, b2, b3, X_test, y_test)*100, '%')
print('DFA Method test error:', test(W1dfa, W2dfa, W3dfa, b1dfa, b2dfa, b3dfa, X_test, y_test)*100, '%')
