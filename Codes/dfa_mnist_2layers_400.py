...
def train2(x, y, n_epochs=10, lr=1e-3, batch_size=200, tol=1e-1):
    ...
    W1, W2, W3 = np.random.randn(400, 784), np.random.randn(400,400), np.random.randn(10, 400)
    b1, b2, b3 = np.random.randn(400, 1), np.random.randn(400,1), np.random.randn(10, 1)
...
def dfa_train2(x, y, n_epochs=10, lr=1e-3, batch_size=200, tol=1e-3):
    ...
    B1 = np.random.randn(400,10)
    B2 = np.random.randn(400,10)
    dataset_size = x.shape[1]
    n_batches = dataset_size//batch_size
    te_dfa = []
    angles = []
